...
.controller('AttenApproveController', function ($scope, $http, $timeout, $filter, $window, AttenApproveService) {
    ...
    function Load_Data() {
        ...
        //// Populate GetEmployeeAttenApproved

        AttenApproveService.GetEmployeeAttenApproved($scope.data).then(function (d) {
            ...
            alert('Error GetEmployeeAttenApproved!');
        });
    ...
    // Populate Unit
    AttenApproveService.GetCompany().then(function (d) {
        $scope.CompanyList = d.data;


        // Populate DeptSec AND  Company Filter
        AttenApproveService.GetEmpDeptSec().then(function (d) {
...
.factory('AttenApproveService', function ($http, $q) {
    ...
    fac.GetEmployeeAttenApproved = function (data) {
        //alert(angular.toJson(data));
        return $http.get('/Attendence/GetEmployeeAttenApproved', {
